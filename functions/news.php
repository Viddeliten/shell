...
function news_show_latest_short($antal, $length=150, $show_auto=1, $headline_size=2, $offset=0, $extra_headline="", $extra_headline_size=2, $print = true)
{
	$echo = "";
	$auto="";
	if(!$show_auto)
...
function news_show($max_nr=10, $extra_headline="", $extra_headline_size=2, $print=true)
{
	$echo = "";
